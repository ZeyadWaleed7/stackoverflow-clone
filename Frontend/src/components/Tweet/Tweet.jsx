...
const tweetData = [
  {
    id: 1,
    displayName: "Zeyad Waleed",
    username: "@ZeyadWaleed7",
    isVerified: true,
    date: "Mar 10",
  ...
  },
  {
    ...
    isVerified: true,
    date: "Mar 9",
    content: "Ready for the Champions League! 💪",
    interactions: {
      replies: "12.5K",
      reposts: "25K",
      likes: "245K",
        ...
        <div className={styles["user-info"]}>
          ...
          <div className={styles["user-details"]}>
            <div className={styles["name-container"]}>
              <span className={styles["display-name"]}>{tweet.displayName}</span>
              {tweet.isVerified && (
      ...
      <div className={styles["tweet-footer"]}>
        <div className={styles["tweet-actions"]}>
          <div className={styles["action-button"]}>
            ...
            <span className={styles["action-count"]}>{tweet.interactions.replies}</span>
          </div>
          <div className={styles["repost-action-button"]}>
            <Repeat2 size={18} />
            <span className={styles["action-count"]}>{tweet.interactions.reposts}</span>
          </div>
          <div className={styles["like-action-button"]}>
            <Heart size={18} />
            <span className={styles["action-count"]}>{tweet.interactions.likes}</span>
          </div>
          <div className={styles["action-button"]}>
            <BarChart3 size={18} />
            <span className={styles["action-count"]}>{tweet.interactions.views}</span>
          </div>
        </div>    
